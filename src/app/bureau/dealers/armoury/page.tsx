...
import DealerBeauralProductCard from "../component/card"
// import DealerBeauralProductCard from "./components/card"
    ...
    return <Grid container >
        {[
            ...
            .map((item, index) => <Grid key={index} p={.5} item md={4} sm={3} >
                <DealerBeauralProductCard name={item.name} qty={item.qty} desc={item.desc}  image={item.image} />
            </Grid>
            )}
